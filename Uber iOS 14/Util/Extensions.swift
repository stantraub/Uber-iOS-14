...
extension UIView {
    ...
    func inputContainerView(image: UIImage, textField: UITextField? = nil, segmentedControl: UISegmentedControl? = nil) -> UIView {
        ...
        if let textField = textField {
            ...
            iv.anchor(left: view.leftAnchor, paddingLeft: 12, width: 24, height: 24)
            
            view.addSubview(textField)
            textField.centerY(inView: view)
            textField.anchor(left: iv.rightAnchor, right: view.rightAnchor, paddingLeft: 8)
        }
        
        if let sc = segmentedControl {
            iv.anchor(top: view.topAnchor, left: view.leftAnchor, paddingTop: -8, paddingLeft: 8, width: 24, height: 24)
